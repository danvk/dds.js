...
var ddsReady = new Promise(function (resolve, reject) {
    ...
    solveBoard = Module.cwrap('solve', 'string', ['string', 'string', 'number', 'number']);
...
function packPlays(plays) {
    ...
    for (var i = 0; i < plays.length; i++) {
        ...
        var suit = SUITS[p[1]], rank = RANKS[p[0]];
 ...
 */
var nextPlays = function (board, trump, plays) {
    var cacheKey = JSON.stringify({ board: board, trump: trump, plays: plays });
 ...
 * {'N': {'N': 1, 'S': 2, 'E': 3, 'W': 4}, 'S': { ... }, ...}
 */
var calcDDTable = function (board) {
